...
<title>Web Page Motor Demo</title>
  ...
  <body style="background-color: #efefef" onload="process()">
    ...
    <header>
      <div class="navbar fixed-top">
          <div class="container">
            <div class="navtitle">Motor Contorl Panel</div>
    ...
    <main class="container" style="margin-top:70px">
      <div class="category">Encoder Reading</div>
    ...
    <br>
    <br>
    <div class="category">Motor Controls</div>
    <br>
    <button type="button" class = "btn" id = "btnF">Forward</button>
    </div>
    <button type="button" class = "btn" id = "btnB">Backward</button>
    </div>
    <br>
    <br>
    <div class="bodytext">Number to send (PWM: <span id="pwmreceived"></span>)</div>
    <br>
    <input type="range" class="pwmslider" min="0" max="100" value = "0" width = "0%" oninput="UpdateSlider(this.value)"/>
    <br>
    <br>
  </main>

  <footer div class="foot" id = "temp" >ESP32 Encoder Monitor and Motor Control Demo</div></footer>
  ...
  <script type = "text/javascript">
    ...
    var forward = document.getElementById("btnF");
    var backward = document.getElementById("btnB");
    ...
    forward.addEventListener("mousedown", function() { //button is pressed
        forward.classList.add("active");
        var xhttp = new XMLHttpRequest();
        xhttp.open("PUT", "Forward_1", false);
        xhttp.send();
    });

    forward.addEventListener("mouseup", function() { //button is released
        forward.classList.remove("active");
        var xhttp = new XMLHttpRequest();
        xhttp.open("PUT", "Forward_0", false);
        xhttp.send();
    });

    backward.addEventListener("mousedown", function() { //button is pressed
        backward.classList.add("active");
        var xhttp = new XMLHttpRequest();
        xhttp.open("PUT", "Backward_1", false);
        xhttp.send();
    });

    backward.addEventListener("mouseup", function() { //button is released
        backward.classList.remove("active");
        var xhttp = new XMLHttpRequest();
        xhttp.open("PUT", "Backward_0", false);
        xhttp.send();
    });
    ...
    function response(){
      ...
      barwidth = message / 10;
      document.getElementById("e0").innerHTML=message;
      document.getElementById("e0").style.width=(barwidth+"%");
